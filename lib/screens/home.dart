...
class FeedCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Function to get a random SVG image widget
    ...
    bool checkLastFeed() {
      if (data.userDetails.designation != null &&
          data.userDetails.designation == "Test") {
        return true;
      }
      return false;
    }
    ...
    return Stack(
      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        data.userDetails.designation ?? "no role",
                        style: TextStyle(
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            " ${Services().formatAgo(data.createdAt)}",
                            style: TextStyle(
                              color: Colors.grey.shade400,
                              fontSize: 10,
                            ),
              ...
              Divider(height: 30, thickness: 1, color: AppColors.borderColor),
              ...
              Text(
                "Brand: ${data.requestDetails == null ? "no brand" : data.requestDetails!.brand}",
              ),
              Text("Type: ${data.description}"),
              SizedBox(height: 10),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 4),
                          Text(
                            "${data.requestDetails?.followersRange?.igFollowersMax ?? 0} - ${data.requestDetails?.followersRange?.igFollowersMin ?? 0}",
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 4),
                          Text(
                            "${data.requestDetails?.categories!.join(', ') ?? 0}",
                            style: TextStyle(
                              fontSize: 11,
                              fontWeight: FontWeight.w700,
                              color: AppColors.secondaryTextColor,
        ...
        Positioned(
          ...
          right: 20,
          child: Visibility(
            visible: data.isHighValue || checkLastFeed(),
            child: FittedBox(
              child: Container(
                padding: EdgeInsetsGeometry.symmetric(
                  vertical: 6,
